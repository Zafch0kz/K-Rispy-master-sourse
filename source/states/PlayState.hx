...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Uninstall dawg.....U suck ass.....', 0.2], //From 0% to 19%
		['Dogshit', 0.4], //From 20% to 39%
		['Nahh', 0.5], //From 40% to 49%
		['Ugh', 0.6], //From 50% to 59%
		['Ehhhh', 0.69], //From 60% to 68%
		['Cool', 0.7], //69%
		['Swag', 0.8], //From 70% to 79%
		['Awesome', 0.9], //From 80% to 89%
		['Poggers!', 1], //From 90% to 99%
		['K-Rispy!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
		...
		timeBar.leftBar.color = FlxColor.BLUE;
